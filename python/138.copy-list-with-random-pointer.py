...
class Solution:
    def copyRandomList(self, head: 'Optional[Node]') -> 'Optional[Node]':
        if not head:
            return None
        l2head = Node(x=head.val, next=None, random=None)
        rand = {}
        l1 = head
        l2 = l2head
        while l1:
            ...
            new_node = Node(x=l1.val, next=None, random=None) if l1 else None
        ...
        l2 = l2head
        while l1:
            l2.random = rand[l1.random] if l1.random else None
            l2 = l2.next
            l1 = l1.next
